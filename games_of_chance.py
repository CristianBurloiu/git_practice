...
def cho_han(guess, bet):
    ...
    totalMoney = dice1 + dice2
    print("The sum of the two dice is " + str(totalMoney))

    if guess == "Even" and totalMoney % 2 == 0:
        print("You won " + str(bet)+" dollars!")
        print("------------------")
        return bet
    elif guess == "Odd" and totalMoney % 2 == 1:
        print("You won " + str(bet)+" dollars!")
        print("------------------")
        return bet
    else:
...
def roulette(guess, bet):
    ...
    #A standard roulette wheel has the numbers 0 through 36 as well as 00. Use 37 to represent 00.
    print("------------------")
    ...
    #Checks to see if I guessed Even and the result was even. If the result was 0, the player shouldn't win
    ...
    #Checks to see if I guessed Odd and the result was odd. If the result was 37, the player shouldn't win, since that's what we are using to represent 00.
...
totalMoney += coin_flip("Heads", 10)
totalMoney += higher_card(5)
totalMoney += cho_han("Even", 2)
totalMoney += roulette("Even", 10)
totalMoney += roulette(3, 1)
totalMoney += roulette("Odd", totalMoney)
print("Your totalMoney amount of money is " + str(totalMoney))
